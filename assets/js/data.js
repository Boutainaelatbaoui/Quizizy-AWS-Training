const questions = [
    {
        ...
        "answer1"     : "Amazon EC2 costs are billed on a monthly basis",
        "answer2"     : "Users retain full administrative access to their Amazon EC2 instances",
        "answer3"     : "Amazon EC2 instances can be launched on demand when needed",
        "answer4"     : "Users can permanently run enough instances to handle peak workloads",
        "response"    : "3",
    ...
    },
    {
        "id"          : 2,
        "quest"    : "Why is AWS more economical than traditional data centers for applications with varying compute workloads?",
        "answer1"     : "AWS Storage Gateway",
        "answer2"     : "AWS Database Migration Service (AWS DMS)",
        "answer3"     : "Amazon EC2",
        "answer4"     : "Amazon AppStream 2.0",
        "response"    : "2",
    ...
    },
    {
        ...
        "answer1"     : "AWS Config",
        "answer2"     : "AWS OpsWorks",
        "answer3"     : "AWS SDK",
        "answer4"     : "AWS Marketplace",
        "response"    : "4",
    ...
    },
    {
        ...
        "answer1"     : "AWS Config",
        "answer2"     : "Amazon Route 53",
        "answer3"     : "AWS Direct Connect",
        "answer4"     : "Amazon Virtual Private Cloud (Amazon VPC)",
        "response"    : "4",
